...
export default function DNA() {
  ...
  useEffect(() => {
    async function loadDNA() {
      const dnaData = await api.athletes.getDNA()
      setAthlete(dnaData)
    }
    loadDNA()
  }, [])

  if (!athlete) return <div className="p-10 text-center text-muted">Loading DNA profile...</div>
  ...
  return (
    <main className="phone nav-safe px-5">
      ...
      <HeroCard
        ...
        subtitle={`Data Completeness: ${athlete.dataCompleteness}%`}
